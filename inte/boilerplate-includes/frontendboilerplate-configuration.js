const config = {
    ...
    */
    ...
    project_preview_links: {
        'tickets': 'https://projects.preview.team/project/5526/issues/kanban',
        'wiki': 'https://projects.preview.team/project/5526/wiki'
    },
    ...
    */
    ...
    generateFavicon: {
        ...
        output: '../wp-content/themes/palm/images/favicon/',

        /* Favicon source */
        src: '../wp-content/themes/palm/images/favicon.png',
