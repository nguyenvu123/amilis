	...
	class CTCC_Public {
						...
						if(!catapultReadCookie("catAccCookies")){ // If the cookie has not been set then show the bar
							...
							?>
								...
								$("html").on('webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend', function(e) {
									...
									$("body").css("margin-top",barHeight+headerHeight);
									$("#mainHeader").css("margin-top",barHeight);
		...
		public function add_notification_bar() {
			...
			if( ! empty( $exclude ) ) {
				...
				if ( $ctcc_styles_settings['position'] == 'top-bar' || $ctcc_styles_settings['position'] == 'bottom-bar' ) {
					$content .= '<div class="ctcc-inner container' . esc_attr ( str_replace ( '.', '', $ctcc_styles_settings['container_class'] ) ) . '">';
